...
Once the `conda-forge` channel has been enabled, `uproot-browser` can be installed with:

```
conda install uproot-browser
```

It is possible to list all of the versions of `uproot-browser` available on your platform with:
