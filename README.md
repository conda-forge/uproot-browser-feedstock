About uproot-browser-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/uproot-browser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/uproot-browser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add uproot-browser
# for installing globally
pixi global install uproot-browser
```
...
It is possible to list all of the versions of `uproot-browser` available on your platform:
...
```
pixi search uproot-browser --channel conda-forge
```
